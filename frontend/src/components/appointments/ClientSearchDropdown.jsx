 ...
 * Filters by name and phone number.
 *
 * @param {Array} clients - Array of client objects
 * @param {object} selectedClient - Currently selected client or null
 * @param {function} onSelect - Called with client object (or null to clear)
        ...
        <>
          <div className="relative">
            <input
              ...
              disabled={disabled}
              className="w-full border border-gray-300 rounded-md px-4 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
            />
