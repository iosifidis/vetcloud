...
VALUES ($1, $2, $3, $4, $5, $6)
RETURNING id, username, password_hash, email, first_name, last_name, is_active, role_id, created_at, updated_at, client_id, oidc_sub
`
...
SELECT u.id, u.username, u.password_hash, u.email, u.first_name, u.last_name, u.is_active, u.role_id, u.created_at, u.updated_at, u.client_id, u.oidc_sub, r.name AS role_name, r.permissions AS role_permissions
FROM users u
...
SELECT u.id, u.username, u.password_hash, u.email, u.first_name, u.last_name, u.is_active, u.role_id, u.created_at, u.updated_at, u.client_id, u.oidc_sub, r.name AS role_name
FROM users u
JOIN roles r ON u.role_id = r.id
